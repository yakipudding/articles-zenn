...
例えば、[Figma Make](https://www.figma.com/ja-jp/make/)は雑なプロンプトから、「それっぽい」画面を作ることは得意です。プロンプトで明確に指示していない機能やボタンなどが勝手に生成されていることもよくあります。

その出力結果を精査せずにそのまま採用していると、根拠のない謎の機能が出来上がってしまいます。それをあとからエキスパートに「この項目はどういう意味なのか？何をもとに出力しているのか？かえって混乱する項目を出すくらいならないほうが良いのでは？」と指摘され、機能の見直しになったことがありました。高速に作れる分、間違った前提がそのまま形になってしまうリスクも同時に大きくなると実感しました。
